...
import { FiUsers, FiFolder, FiCheckSquare, FiFileText } from 'react-icons/fi'
        ...
        <div className="w-64 bg-white border-r border-gray-200 p-4 overflow-y-auto">
          <nav className="space-y-2">
            ...
            <button
              ...
              className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition ${
                activeTab === 'tasks' ? 'bg-blue-50 text-blue-600' : 'text-gray-700 hover:bg-gray-50'
              }`}
            >
                        ...
                        {stats.recent_users.slice(0, 5).map(user => (
                          <div key={user.id} className="flex items-center justify-between p-3 bg-gray-50 rounded">
                            ...
                            <span className={`px-2 py-1 text-xs rounded font-medium ${
                              user.is_admin ? 'bg-red-100 text-red-700' : 'bg-gray-200 text-gray-700'
                            }`}>
